...
private:
    ...
    void _TransfetLogRecord(double Amount, clsBankClient DestinationClient, string UserName)
    {
    ...
    static stTransferLogRecord _ConvertTransferLogLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        TransferLogRecord.DateTime = vLoginRegisterDataLine[0];
        TransferLogRecord.SourceAccountNumber = vLoginRegisterDataLine[1];
        TransferLogRecord.DestinationAccountNumber = vLoginRegisterDataLine[2];
        TransferLogRecord.Amount = stod(vLoginRegisterDataLine[3]);
        TransferLogRecord.srcBalanceAfter = stod(vLoginRegisterDataLine[4]);
        TransferLogRecord.destBalanceAfter = stod(vLoginRegisterDataLine[5]);
        TransferLogRecord.UserName = vLoginRegisterDataLine[6];
...
public:
    ...
    bool Transfer(double Amount, clsBankClient& DestinationClient ,string UserName)
    {
        ...
        _TransfetLogRecord(Amount, DestinationClient, UserName);
        return true;
